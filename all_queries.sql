...
SELECT b.book_name, CONCAT(ba.firstname, ' ', ba.lastname) AS 'Author Name'
FROM book b
INNER JOIN book_author_classification bac ON b.BookID = bac.BookID
INNER JOIN book_author ba ON bac.AuthorID = ba.AuthorID;
